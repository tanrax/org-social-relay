...
class Group(models.Model):
    ...
    """
    name = models.CharField(max_length=100, unique=True, help_text="Group name (no spaces)")
    ...
    is_public = models.BooleanField(default=True, help_text="Whether the group is publicly accessible")
...
class GroupPost(models.Model):
    ...
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='shared_in_groups')
    shared_by = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='shared_posts')
...
class GroupInvitation(models.Model):
    ...
    invited_profile = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='group_invitations')
    invited_by = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='sent_group_invitations')
