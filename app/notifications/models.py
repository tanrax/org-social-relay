...
class Mention(models.Model):
    ...
    mentioned_profile = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='mentions_received')
    mentioned_nickname = models.CharField(max_length=100, help_text="Nickname used in the mention")
...
class Reply(models.Model):
    ...
    """
    reply_post = models.OneToOneField(Post, on_delete=models.CASCADE, related_name='reply_info')
    original_post_url = models.URLField(help_text="URL of the original post")
    original_post_id = models.CharField(max_length=50, help_text="ID of the original post")
    original_profile = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='replies_received', null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class Notification(models.Model):
    ...
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='generated_notifications')
